export const invalidFirstNameMessage = 'First Name should be greater than 2 and less than 16';
export const invalidSecondNameMessage = 'Second Name should be greater than 2 and less than 16';
